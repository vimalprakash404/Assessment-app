...
// admin  authentication functions s


// validation middleware for create admin 
    ...
    try {
        ...
        return new Promise((resolve, reject) => {
            readableStream
                ...
                .on('end', async () => {
                    const fields = Object.keys(results[0]); // Extracting field names from the first row
                    const json2csvParser = new Parser({ fields }); // Creating json2csv parser
                    const csvData = json2csvParser.parse(results); // Convert array of objects to CSV string
...
//  
module.exports = { createUsers, upload ,create , createAdminValidator  ,login }